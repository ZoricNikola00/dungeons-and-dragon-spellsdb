...
describe('Spell component', () => {
  ...
  it('should display favorite component and check remove option', () => {
    ...
    const selectorMock = {
      ...
      isLoading: false,
      favorite: [
        { index: 'fire', name: 'Fire', url: '/fire' },
        { index: 'ice', name: 'Ice', url: '/ice' },
        { index: 'frost', name: 'Frost', url: '/frost' },
      ],
    }
    ;(useAppSelector as jest.Mock).mockReturnValue(selectorMock)
    renderWithProvider(<Favorite />)
    ...
    expect(dispatchMock).toHaveBeenCalledWith({
      ...
      payload: { index: 'fire', name: 'Fire', url: '/fire' },
    })
  })
})
