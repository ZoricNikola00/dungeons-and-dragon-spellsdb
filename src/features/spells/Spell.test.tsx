...
describe('Spell component', () => {
  ...
  it('should display loading component',()=>{
    ...
    const selectorMock = { spells: [{index:'test-spell1', name: 'Test Spell 1', url:'/test-spell1' },{index:'test-spell2', name: 'Test Spell 2', url:'/test-spell2' }], isLoading: true, favorite: [] };
...
it('renders Spell component and check favorite option', () => {
    ...
    expect(dispatchMock).toHaveBeenCalledWith({ type: 'spells/addFavorite', payload: {
      name: 'test spell',
      index: 'test-spell',
      level: 6,
      components: ['V', 'S', 'M'],
